PERU_LOCATIONS = {
    ...
    "Apurímac": {
        ...
        "Andahuaylas": ["Andahuaylas", "Andarapa", "Chiara", "Huancarama", "Huancaray", "Huayana", "Kishuara", "Pacobamba", "Pacucha", "Pampachiri", "Pomacocha", "San Antonio de Cachi", "San Jerónimo", "San Miguel de Chaccrampa", "Santa María de Chicmo", "Talavera", "Tumay Huaraca", "Turpo", "Kaquiabamba"],
    ...
    "Arequipa": {
        ...
        "Caravelí": ["Caravelí", "Acarí", "Atico", "Atiquipa", "Bella Unión", "Cahuacho", "Chala", "Cháparra", "Huanuhuanu", "Jaqui", "Lomas", "Quicacha", "Yauca"],
    ...
    "Cajamarca": {
        ...
        "Chota": ["Chota", "Anguia", "Chadín", "Chalamarca", "Chiguirip", "Chimban", "Choropampa", "Cochabamba", "Conchan", "Huambos", "Lajas", "Llama", "Miracosta", "Paccha", "Pion", "Querocoto", "San Juan de Licupis", "Tacabamba", "Tocmoche"],
        ...
        "San Marcos": ["San Marcos", "Chancay", "Eduardo Villanueva", "Gregorio Pita", "Ichocán", "José Manuel Quiroz", "José Sabogal"],
    ...
    "Cusco": {
        ...
        "La Convención": ["Quillabamba", "Echarate", "Huayopata", "Maranura", "Ocobamba", "Quellouno", "Kimbiri", "Santa Ana", "Vilcabamba", "Pichari", "Inkawasi", "Villa Virgen", "Villa Kintiarina", "Megantoni"],
    ...
    "Huánuco": {
        "Huánuco": ["Huánuco", "Amarilis", "Chinchao", "Churubamba", "Margos", "Pillco Marca", "Quisqui", "San Francisco de Cayrán", "San Pedro de Chaulán", "Santa María del Valle", "Yarumayo", "Yacus"],
        ...
        "Marañón": ["Huacrachuco", "Cholon", "La Morada", "San Buenaventura", "Santa Rosa de Alto Yanajanca"],
    ...
    "Junín": {
        "Huancayo": ["Huancayo", "Carhuacallanga", "Chacapampa", "Chicche", "Chilca", "Chongos Alto", "Chupuro", "Colca", "Cullhuas", "El Tambo", "Huacrapuquio", "Hualhuas", "Huancán", "Huasicancha", "Huayucachi", "Ingenio", "Pariahuanca", "Pilcomayo", "Pucara", "Quichuay", "Quilcas", "San Agustín", "San Jerónimo de Tunán", "Saño", "Sapallanga", "Sicaya", "Santo Domingo de Acobamba", "Viques"],
    ...
    "Loreto": {
        ...
        "Mariscal Ramón Castilla": ["Caballo Cocha", "Pebas", "Ramón Castilla", "Yavari"],
    ...
    "Madre de Dios": {
        ...
        "Manu": ["Salvación", "Fitzcarrald", "Manu", "Madre de Dios"],
    ...
    "Puno": {
        ...
        "Melgar": ["Ayaviri", "Antauta", "Cupi", "Llalli", "Macari", "Ñuñoa", "Orurillo", "Santa Rosa", "Umachiri"],
